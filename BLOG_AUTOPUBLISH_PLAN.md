...
## Manual publishing right now (no automation required)

If you want to keep deployment manual for now:

1. Follow `blog/README.md` to create the new article page from `blog/article-template.html`.
2. Add a new card to `blog/index.html`.
3. Add the URL to `sitemap.xml`.
4. Commit and deploy.

This gives you a reliable workflow today while you phase in full sheet-based automation later.
